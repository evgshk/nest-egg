...
import {
  ReactiveLabelComponent, ReactiveSubLabelComponent,
  ReactiveCheckBoxComponent, ReactiveInputComponent,
...
@NgModule({
  declarations: [...APP_REACTIVE_COMPONENTS, ...APP_DECORATIONS_COMPONENTS, OnInputValueControlDirective, ValueTransformPipe],
  imports: [CommonModule, FormsModule, ReactiveFormsModule, ...NZ_MODULES],
  exports: [CommonModule, FormsModule, ReactiveFormsModule, ...APP_REACTIVE_COMPONENTS]
})
